...
DROP POLICY IF EXISTS "Users can manage their own debt types" ON public.debt_types; -- Erro reportado pelo usuário
...
-- 4. Desativar RLS para evitar bloqueios nas APIs (como solicitado)
